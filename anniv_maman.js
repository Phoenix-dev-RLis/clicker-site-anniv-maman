...
const buttonJoyeuxAnniversaire = document.getElementById("joyeux-anniversaire");   

buttonJoyeuxAnniversaire.addEventListener("click", function() {
    if (anniv_mod === true){
        window.open("https://www.youtube.com/watch?v=l04BpnlteSY");
    }
});


const annivButton = document.getElementById("anniv-button");

annivButton.addEventListener("click", function() {
if (anniv_mod == false){
anniv_mod = true;
annivButton.innerText = "Mode Anniv activé";
}else{
anniv_mod = false;
annivButton.innerText = "Mode Anniv";
}
